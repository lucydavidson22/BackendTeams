...
const pa01Routes = require('./prove01-routes.js');
const pa02Routes = require('./routes/teamRoutes/ta02');
const pa03Routes = require('./routes/teamRoutes/ta03');
const pa04Routes = require('./routes/teamRoutes/ta04');
